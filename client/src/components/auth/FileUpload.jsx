...
export function FileUpload({
 ...
 : "border-slate-200 bg-white/50 hover:border-brand-400 hover:bg-brand-50/40:border-brand-500"
 )}
 >
 <input
 ref={inputRef}
...
export function DocumentListItem({ icon: Icon = IdCard, title, status = "Not uploaded" }) {
 return (
 <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white/60 p-3.5">
