        ...
        {passwordRules.map((_, i) => (
          <span
            ...
            className={cn(
              ...
              i < score ? `bg-current ${LEVEL_TEXT[score]}` : "bg-slate-200 dark:bg-ink-700"
            )}
          />
        ))}
      </div>
            ...
            >
              <span
                className={cn(
                  ...
                  pass
                    ? "bg-mint-100 text-mint-600 dark:bg-mint-500/20"
                    : "bg-slate-100 text-slate-400 dark:bg-ink-800"
                )}
              >
              ...
              <span
                className={cn(
                  pass ? "text-mint-600 dark:text-mint-400" : "text-slate-500 dark:text-ink-400"
                )}
              >
                {rule.label}
              </span>
