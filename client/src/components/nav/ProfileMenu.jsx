...
const ProfileMenu = memo(function ProfileMenu() {
 ...
 role="menu"
 className="absolute right-0 mt-2 w-64 origin-top-right overflow-hidden rounded-2xl border border-slate-100 bg-white/95 p-2 shadow-lift backdrop-blur"
 >
 <div className="flex items-center gap-3 rounded-xl bg-slate-50/80 px-3 py-3">
 ...
 className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-brand-50 hover:text-brand-700:bg-brand-500/10:text-brand-300"
 >
