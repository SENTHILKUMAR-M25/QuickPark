...
<motion.div
 ...
 <span className="text-xs font-bold text-mint-600">{k.delta}</span>
 </div>
 ...
 whileInView="show"
 viewport={{ once: true }}
 className="mx-auto mt-6 flex max-w-5xl flex-col items-center justify-between gap-5 rounded-3xl border border-slate-100 bg-gradient-to-r from-slate-50 to-white p-6 shadow-soft sm:flex-row lg:px-8"
 >
 <div>
 <p className="text-sm text-slate-500">
 Good to see you, <span className="font-semibold text-ink">{user?.name?.split(" ")[0]}</span>. {`3`} new booking
 ...
 className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-5 py-2.5 text-sm font-semibold text-ink transition-colors hover:border-mint-300"
 >
