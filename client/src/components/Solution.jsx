  ...
  return (
    <section id="solution" className="relative overflow-hidden bg-[#f6f7fb] py-20 lg:py-28">
      ...
      <div className="container-x relative">
        ...
        {/* Updated Grid Layout - 2x3 on mobile, 2x3 on tablet, 3x2 on desktop */}
        <div className="mt-14 grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          
          {/* Find nearby parking - Full width on mobile, spans 2 cols on tablet and up */}
          <CardShell className="sm:col-span-2 lg:col-span-2">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-50 text-brand-600">
              <Search size={21} strokeWidth={2.2} />
            </div>
            <h3 className="mt-4 font-display text-xl font-bold text-ink">Find nearby parking</h3>
          ...
          {/* Safe verified locations - Full width on mobile and tablet, spans 3 cols on desktop */}
          <CardShell className="sm:col-span-2 lg:col-span-3">
            <div className=" flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
              <div className="min-w-0 flex-1">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-mint-50 text-mint-600">
                  <ShieldCheck size={21} strokeWidth={2.2} />
                </div>
              ...
              <IsoParking className="w-full  shrink-0 self-center sm:w-52 sm:self-auto md:w-56" />
            </div>
            <div className="mt-5 flex flex-wrap gap-2">
              {["GPS Verified", "Owner ID Check", "Community Rated", "24/7 Support", "CCTV Friendly"].map((b) => (
                <span key={b} className="flex items-center gap-1.5 rounded-full bg-mint-50 px-3 py-1.5 text-xs font-semibold text-mint-700">
