  ...
  return (
    <AuthShell backTo="/" panel={{ headline: "You've taken a wrong turn.", subline: "Let's get you back to parking." }}>
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-3 font-display text-3xl font-bold tracking-tight text-ink dark:text-white">
          Page not found
        </h1>
        <p className="mt-3 text-sm leading-relaxed text-slate-500 dark:text-ink-400">
