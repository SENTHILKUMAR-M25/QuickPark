    ...
    <AuthShell backTo="/" panel={{ headline: "You're all set.", subline: "Welcome to the Quick Park family." }}>
      <div className="flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="font-display text-3xl font-bold tracking-tight text-ink dark:text-white"
        >
          {config.title}
        </motion.h1>
        <motion.p
          ...
          className="mt-3 text-sm leading-relaxed text-slate-500 dark:text-ink-400"
        >
          {config.message}
        </motion.p>
